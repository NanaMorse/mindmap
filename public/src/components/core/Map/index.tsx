...
class Map extends React.Component<MapProps, void> {
   ...
   * */
  getParentOfTopicNode(topicInfo: topicInfo, treeLevelToCheck: topicInfo = this.props.map): topicInfo {
   ...
   * */
  renderTopicTree() {
    const extendedTopicInfo = this.calcExtendedTopicTreeInfo(this.props.map);
